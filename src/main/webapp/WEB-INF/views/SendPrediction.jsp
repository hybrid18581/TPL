...
<br>
     ...
     <div class="content-wrapper">
		<div class="container-fluid">
			<ol class="breadcrumb">
				<li class="breadcrumb-item" id="SendPredictions"><a href="#">Send Predictions</a></li>
              ...
              <thead class="thead-dark">
   				...
   				<c:forEach items="${leaguePredictList}" var="leagueList">
							...
							<tr align="center" class="courseRow">
								...
								<td>
			<button type="button" class="btn btn-link"
			onClick="sendPrediction('${leagueList.teamName}','${leagueList.leagueId}','${leagueList.teamId}')">Change Prediction</button>
			</td>
			</c:if>	
								</c:if>
